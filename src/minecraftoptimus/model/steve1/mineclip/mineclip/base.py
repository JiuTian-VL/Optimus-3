...
import minecraftoptimus.model.steve1.mineclip.utils as U
...
class VideoRewardBase(nn.Module):
    ...
    def forward_image_features(self, frames):
        ...
        frames = U.basic_image_tensor_preprocess(frames, mean=MC_IMAGE_MEAN, std=MC_IMAGE_STD)
    ...
    def load_ckpt(self, ckpt_or_path, strip_prefix="model.", strict=False):
        ...
        ret = U.load_state_dict(self, ckpt["state_dict"], strip_prefix=strip_prefix, strict=strict)
        return ret
