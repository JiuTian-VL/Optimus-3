...
from minecraftoptimus.model.deepseek_vl2.models.siglip_vit import VisionTransformer

from .configuration_optimus3_deepseekvl2 import Optimus3DeepSeekConfig
from .modeling_optimus3_deepseek_moe import DeepseekV2ForCausalLM
...
class DeepseekVLV2Config(PretrainedConfig):
    model_type = "optimus3_deepseek_vl2"
    vision_config: VisionEncoderConfig
    projector_config: MlpProjectorConfig
    language_config: Optimus3DeepSeekConfig
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(language_config, Optimus3DeepSeekConfig):
            self.language_config = language_config
        else:
            self.language_config = Optimus3DeepSeekConfig(**language_config)
...
class DeepseekVLV2PreTrainedModel(PreTrainedModel):
    ...
    base_model_prefix = "optimus3_deepseek_vl2"
    _no_split_modules = []
        ...
        for i in range(0, prefilling_len, chunk_size):
            ...
            if past_key_values is not None:
                position_ids = torch.arange(
                    chunk_start, chunk_end, dtype=torch.long, device=inputs_embeds.device
                ).unsqueeze(0)
...
AutoConfig.register("optimus3_deepseek_vl2", DeepseekVLV2Config)
AutoModelForVision2Seq.register(DeepseekVLV2Config, DeepseekVLV2ForCausalLM)


_register_composite_model(
    model_type="optimus3_deepseek_vl2",
    projector_key="mlp_projector",
    vision_model_keys=["vision.patch_embed", "vision.blocks"],
    language_model_keys=["model", "lm_head"],
    lora_conflict_keys=["patch_embed"],
)

register_template(
    name="optimus3_deepseek_vl2",
