...
class _FakeEnvMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._fake_malmo_data = np.load(
            os.path.join(os.path.abspath(os.path.dirname(__file__)), "info.npz"), allow_pickle=True
        )["arr_0"].tolist()
    ...
    def _send_mission(self, _, mission_xml_etree: etree.Element, token_in: str) -> None:
        logger.debug("Sending fake XML for {}:".format(token_in) + etree.tostring(mission_xml_etree).decode())
    ...
    def step(
        self, action
    ) -> Tuple[Dict[str, Dict[str, Any]], Dict[str, float], Dict[str, bool], Dict[str, Dict[str, Any]]]:
