...
class _SingleAgentEnv(_MultiAgentEnv):
    ...
    def step(self, single_agent_action: Dict[str, Any]) -> Tuple[Dict[str, Any], float, bool, Dict[str, Any]]:
    ...
    def execute_cmd(self, command: str) -> Tuple[Dict[str, Any], float, bool, Dict[str, Any]]:
