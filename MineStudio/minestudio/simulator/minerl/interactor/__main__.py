...
import argparse
from minestudio.simulator.minerl.env._multiagent import _MultiAgentEnv
from minestudio.simulator.minerl.env.malmo import InstanceManager, MinecraftInstance, malmo_version
...
def parse_args():
    ...
    parser.add_argument("port", type=int, default=8888, help="The minecraft server port to connect to.")
    # ip default localhost
    parser.add_argument("-i", "--ip", default="127.0.0.1", help="The ip to connect to.")
    parser.add_argument("--debug", action="store_true", help="If this is set, then debug logging will be enabled.")
