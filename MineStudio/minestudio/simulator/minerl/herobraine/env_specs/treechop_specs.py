...
from minestudio.simulator.minerl.herobraine.env_specs.human_controls import SimpleHumanEmbodimentEnvSpec
from minestudio.simulator.minerl.herobraine.hero.mc import MS_PER_STEP, STEPS_PER_MS
