...
class _PitchObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["pitch"], space=spaces.Box(low=-180.0, high=180.0, shape=(), dtype=float), default_if_missing=0.0
        )
...
class _YawObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["yaw"], space=spaces.Box(low=-180.0, high=180.0, shape=(), dtype=float), default_if_missing=0.0
        )
...
class _BiomeIDObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["biome_id"], space=spaces.Box(low=0, high=167, shape=(), dtype=int), default_if_missing=0
        )
...
class _BiomeRainfallObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["biome_rainfall"], space=spaces.Box(low=0.0, high=1.0, shape=()), default_if_missing=0.5
        )
...
class _BiomeTemperatureObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["biome_temperature"], space=spaces.Box(low=0.0, high=1.0, shape=()), default_if_missing=0.5
        )
...
class _SeaLevelObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["sea_level"], space=spaces.Box(low=0.0, high=255, shape=(), dtype=int), default_if_missing=63
        )
...
class _LightLevelObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["light_level"], space=spaces.Box(low=0.0, high=15, shape=(), dtype=int), default_if_missing=15
        )
...
class _IsRainingObservation(_FullStatsObservation):
    def __init__(self):
        super().__init__(
            key_list=["is_raining"], space=spaces.Box(low=0, high=1, shape=(), dtype=int), default_if_missing=0
        )
...
class _CanSeeSkyObservation(_FullStatsObservation):
    ...
    def __init__(self):
        super().__init__(
            key_list=["can_see_sky"], space=spaces.Box(low=0, high=1, shape=(), dtype=int), default_if_missing=1
        )
