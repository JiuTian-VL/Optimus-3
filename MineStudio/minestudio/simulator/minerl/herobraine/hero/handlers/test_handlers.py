...
from minestudio.simulator.minerl.herobraine.hero.handlers.agent.observations.compass import CompassObservation
from minestudio.simulator.minerl.herobraine.hero.handlers.agent.observations.inventory import FlatInventoryObservation
from minestudio.simulator.minerl.herobraine.hero.handlers.agent.observations.equipped_item import _TypeObservation
from minestudio.simulator.minerl.herobraine.hero.handlers.agent.action import ItemListAction
...
def test_merge_item_list_command_actions():
    ...
    ) == TestItemListCommandAction(["none", "A", "B", "C", "D", "E", "F"], _other="none")
...
def test_merge_type_observation():
    ...
    type_obs_result = _TypeObservation(
        "test", ["none", "A", "B", "C", "D", "E", "F", "other"], _default="none", _other="other"
    )
    assert type_obs_a | type_obs_b == type_obs_result


def test_merge_flat_inventory_observation():
    assert FlatInventoryObservation(["stone", "sandstone", "lumber", "wood", "iron_bar"]) | FlatInventoryObservation(
