...
import numpy as np
from minestudio.simulator.minerl.herobraine.hero.spaces import MineRLSpace
...
class TranslationHandlerGroup(TranslationHandler):
    ...
    def __init__(self, handlers: List[TranslationHandler]):
        ...
        super(TranslationHandlerGroup, self).__init__(spaces.Dict([(h.to_string(), h.space) for h in self.handlers]))
