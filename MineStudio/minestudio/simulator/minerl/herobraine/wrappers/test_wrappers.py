...
from minestudio.simulator.minerl.herobraine.hero.test_spaces import assert_equal_recursive

import minestudio.simulator.minerl.herobraine.wrappers as wrappers
import minestudio.simulator.minerl.herobraine.envs as envs
from minestudio.simulator.minerl.herobraine.wrappers.util import union_spaces
import numpy as np


def test_obf_wrapper(
    base_env=envs.MINERL_OBTAIN_DIAMOND_V0, common_envs=[envs.MINERL_NAVIGATE_DENSE_V0, envs.MINERL_OBTAIN_DIAMOND_V0]
):
    """
