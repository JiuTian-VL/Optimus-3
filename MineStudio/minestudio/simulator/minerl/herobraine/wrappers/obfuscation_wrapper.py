...
from minestudio.simulator.minerl.herobraine.wrappers.vector_wrapper import Vectorized
...
class Obfuscated(EnvWrapper):
    def __init__(self, env_to_wrap: Vectorized, obfuscator_dir, name=""):
        ...
        """
        self.obf_vector_len, self.ac_enc, self.ac_dec, self.obs_enc, self.obs_dec = Obfuscated._get_obfuscator(
            obfuscator_dir
        )
        ...
        assert isinstance(env_to_wrap, Vectorized), (
