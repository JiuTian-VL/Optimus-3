...
class SAM2CameraPredictor(SAM2Base):
    ...
    def add_new_prompt(
        ...
        assert bbox is not None or points is not None, "Either bbox or points is required"
    ...
    def propagate_in_video_preflight(self):
        ...
        for point_inputs_per_frame in self.condition_state["point_inputs_per_obj"].values():
            input_frames_inds.update(point_inputs_per_frame.keys())
        for mask_inputs_per_frame in self.condition_state["mask_inputs_per_obj"].values():
    ...
    def propagate_in_video(
        ...
        for frame_idx in tqdm(processing_order, desc="propagate in video"):
            ...
            self.condition_state["frames_already_tracked"][frame_idx] = {"reverse": reverse}
    ...
    def _get_image_feature(self, frame_idx, batch_size):
        ...
        image, backbone_out = self.condition_state["cached_features"].get(frame_idx, (None, None))
