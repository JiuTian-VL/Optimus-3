...
from minestudio.data.minecraft.optimus3_dataset import MinecraftDataset as Optimus3MinecraftDataset
...
class MineDataModule(pl.LightningDataModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.kwargs = kwargs
        self.is_optimus3_pretrain = kwargs.get("is_optimus3_pretrain", False)

    def setup(self, stage: Optional[str] = None):
        self.train_dataset = Optimus3MinecraftDataset(
            split="train", shuffle=self.shuffle_episodes, **self.data_params, **self.kwargs
        )
        if not self.is_optimus3_pretrain:
            self.val_dataset = Optimus3MinecraftDataset(
