...
def behavioural_cloning_train(data_dir, in_model, in_weights, out_weights):
    ...
    data_loader = DataLoader(dataset_dir=data_dir, n_workers=N_WORKERS, batch_size=BATCH_SIZE, n_epochs=EPOCHS)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data-dir", type=str, required=True, help="Path to the directory containing recordings to be trained on"
    )
